...
public class DebugPanelWindow : EditorWindow
{
	...
	GUIStyle valueTextStyle = new GUIStyle();
	GUIStyle traceButtonStyle = new GUIStyle();
	...
	void DrawFieldHeader(string key)
	{
		...
		{
			case "System":
				GUI.backgroundColor = systemColor;
				break;
			case "Warning":
	...
	void DrawField(string key)
	{
		...
		{
			case "System":
				fieldTextStyle.normal.textColor = systemColor;
				break;
			case "Warning":
				fieldTextStyle.normal.textColor = warningColor;
				break;
			case "Error":
				fieldTextStyle.normal.textColor = errorColor;
				break;
			default:
				fieldTextStyle.normal.textColor = Color.white;
				break;
